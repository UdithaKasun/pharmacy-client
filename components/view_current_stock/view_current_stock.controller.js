pharmacyApp.controller('drugStockController', ['$scope', 'drugCategoryService', 'drugFrequencyService', 'drugDosageService', 'drugService', function ($scope, drugCategoryService, drugFrequencyService, drugDosageService, drugService) {
